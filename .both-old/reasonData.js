dataX["reasonIntro"] = {
  name: "Introduction: Reason It's Happened",
  descriptionTemplate: "reasonDescription",
  nextTemplate: "scaffold",
  nextType: "reasonScaffold",
       
  examples: [
    {
      exampleTemplate: "reasonExample",
      headline: "McDonald’s Testing Customizable Burgers To Compete With Chipotle",
      headlineId: "37064",
      description: "",
      voice: "Stories like this really make you appreciate how hard corporations work to make us happy.",
...
dataX["reasonScaffold"] = {
  name: "Practice: Identifying Reasons",
  descriptionTemplate: "reasonScaffoldDescription",
  nextTemplate: "exercise",
  nextType: "reasonExercise",
  
  examples: [
    {
      exampleTemplate: "reasonScaffold",
 ...
 /* 
dataX["reasonExercise"] = {
    name: "Exercise: Brainstorming Reasons",
    descriptionTemplate: "reasonExerciseInstructions",
    nextTemplate: "introduction",
    nextType: "detailsIntro",
    examples: [
      
      {
        exampleTemplate: "reasonExercise",
        headline: "",
